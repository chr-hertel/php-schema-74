...
class ClientCapabilitiesTest extends TestCase
{
    ...
    {
        $capabilities = new ClientCapabilities(true, true);
    ...
    {
        $capabilities = new ClientCapabilities(false, null, true, null, null, null, true, true);
    ...
    {
        $capabilities = new ClientCapabilities(false, null, true);
    ...
    {
        $capabilities = new ClientCapabilities(false, null, null, true, null, null, null, null, true, true);
    ...
    {
        $capabilities = new ClientCapabilities(false, null, null, null, null, null, null, null, null, true);
