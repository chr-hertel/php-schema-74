...
class NonObjectOutputSchemaTest extends TestCase
{
     ...
     */
    public function testStructuredContentHoldsAnyJsonValue($value): void
    {
     ...
     * @dataProvider provideStructuredValues
     */
    public function testNonNullValueIsSerialized($value): void
    {
        $result = new CallToolResult([new TextContent('ok')], false, $value);
     ...
     * @dataProvider provideStructuredValues
     */
    public function testRoundTrip($value): void
    {
