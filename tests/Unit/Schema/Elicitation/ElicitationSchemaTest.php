...
final class ElicitationSchemaTest extends TestCase
{
    ...
    public function testConstructorWithMultipleTypes(): void
    {
        $properties = [
            'name' => new StringSchemaDefinition('Name'),
            'age' => new NumberSchemaDefinition('Age', true),
    ...
    public function testJsonSerializeWithFullSchema(): void
    {
        $schema = new ElicitationSchema(
            [
                'name' => new StringSchemaDefinition('Full Name', 'Your full name'),
                'age' => new NumberSchemaDefinition('Age', true, null, null, 0, 150),
                'subscribe' => new BooleanSchemaDefinition('Subscribe', null, false),
            ],
            ['name', 'age'],
        );
