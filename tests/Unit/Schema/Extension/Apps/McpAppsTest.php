...
class McpAppsTest extends TestCase
{
    ...
    {
        $csp = new UiResourceCsp(['https://api.example.com']);
    ...
    {
        $perms = new UiResourcePermissions(false, false, false, true);
    ...
    public function testUiResourceContentMetaSerialization(): void
    {
        $meta = new UiResourceContentMeta(
            new UiResourceCsp(['https://api.example.com']),
            new UiResourcePermissions(false, false, false, true),
            'example.com',
            true,
        );
    ...
    {
        $meta = new UiResourceContentMeta(null, null, null, true);
    ...
    public function testUiToolMetaSerialization(): void
    {
        $meta = new UiToolMeta(
            'ui://my-app',
            [ToolVisibility::Model(), ToolVisibility::App()],
        );
