...
final class CreateSamplingMessageRequestTest extends TestCase
{
    ...
    public function testToolsAndToolChoiceRoundTrip(): void
    {
        ...
        $request = new CreateSamplingMessageRequest([new SamplingMessage(Role::User(), new TextContent('Weather in Paris?'))], 150, null, null, null, null, null, null, [$tool], new ToolChoice(ToolChoiceMode::Required()));
        ...
        $hydrated = CreateSamplingMessageRequest::fromArray(json_decode(json_encode($payload, \JSON_THROW_ON_ERROR), true, 512, \JSON_THROW_ON_ERROR));
