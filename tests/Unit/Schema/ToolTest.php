...
class ToolTest extends TestCase
{
    ...
    {
        $tool = new Tool('t', null, ['type' => 'object', 'properties' => ['q' => ['type' => 'string']], 'required' => null], null, null, null, null, ['type' => 'object', 'properties' => []]);
    ...
    public function testConstructorNormalizesEmptySubSchemasInOutputSchema(string $schemaJson): void
    {
        ...
        $schema = json_decode($schemaJson, true, 512, \JSON_THROW_ON_ERROR);
        $tool = new Tool('t', null, self::validInputSchema(), null, null, null, null, $schema);
