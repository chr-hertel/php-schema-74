...
final class ElicitRequest extends Request
{
     ...
     * @readonly
     */
    public ?ElicitationSchema $requestedSchema = null;
    /**
     * @readonly
     */
    public ElicitationMode $mode;
    /**
     * @readonly
     */
    ...
    public function __construct(
        string $message,
        ?ElicitationSchema $requestedSchema = null,
        ?ElicitationMode $mode = null,
        ?string $url = null
    ) {
        $mode = $mode ?? ElicitationMode::Form();
