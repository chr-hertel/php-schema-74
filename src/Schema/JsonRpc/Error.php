...
class Error implements MessageInterface
{
     ...
     */
    public function __construct($id, int $code, string $message, $data = null)
    {
        $this->id = $id;
        $this->code = $code;
     ...
     */
    final public static function forParseError(string $message, $id = null): self
    {
     ...
     * @param string|int|null $id
     */
    final public static function forInvalidRequest(string $message, $id = null): self
    {
     ...
     * @param string|int|null $id
     */
    final public static function forMethodNotFound(string $message, $id = null): self
    {
     ...
     * @param string|int|null $id
     */
    final public static function forInvalidParams(string $message, $id = null, $data = null): self
    {
     ...
     * @param string|int|null $id
     */
    final public static function forInternalError(string $message, $id = null): self
    {
     ...
     * @param string|int|null $id
     */
    final public static function forServerError(string $message, $id = null): self
    {
     ...
     * @param string|int|null $id
     */
    final public static function forResourceNotFound(string $message, $id = null): self
    {
     ...
     * @param string|int|null $id
     */
    final public static function forHeaderMismatch(string $message, $id = null): self
    {
