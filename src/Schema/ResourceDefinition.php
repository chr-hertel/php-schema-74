...
class ResourceDefinition implements \JsonSerializable
{
    ...
    public static function fromArray(array $data): self
    {
        ...
        return new self(
            ...
            $data['mimeType'] ?? null,
            Annotations::tryFromArray($data['annotations'] ?? null, 'ResourceDefinition'),
            $data['size'] ?? null,
            isset($data['icons']) && \is_array($data['icons']) ? Icon::listFromArray($data['icons'], 'ResourceDefinition') : null,
